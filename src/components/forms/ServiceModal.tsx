        ...
        <form onSubmit={onSubmit} className="sm-form">
            ...
            <div className="sm-row">
              ...
              <div className="sm-field">
                ...
                <input className="sm-input" type="text" placeholder="Company name" required value={form.company} onChange={onChange('company')} />
              </div>
            </div>
            <div className="sm-row">
              <div className="sm-field">
            ...
            <div className="sm-row">
              ...
              <div className="sm-field sm-field-narrow">
                ...
                <input className="sm-input" type="text" placeholder="Apt 4B" required value={form.apartment} onChange={onChange('apartment')} />
              </div>
            </div>
            <div className="sm-row">
              <div className="sm-field sm-field-narrow">
