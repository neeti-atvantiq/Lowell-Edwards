...
const credentials = [
  {
    ...
    brands: [
      { name: 'ButterflyMX', sub: 'Authorized installation partner' },
      { name: 'Akuvox', sub: 'AI biometric specialist partner' },
      { name: 'DoorBird', sub: 'Premium German installer program' },
    ],
  },
  {
...
const pillars = [
  {
    ...
    body: 'Every property is different. Every brief gets reviewed by a real engineer who understands intercom systems, building codes, and the specific contexts where each manufacturer leads.',
    points: ['Free site survey for all projects', 'Itemized, transparent specification', 'Honest brand recommendation — even if it\'s not us', 'No hidden fees, no upsell pressure'],
  },
  {
    num: 'ii. Guarantees',
  ...
  },
  {
    ...
    points: ['Triple-certified integrator', 'Site-specific engineer training per brand', 'Licensed and insured electrical work', 'Documented privacy compliance for biometric installs'],
  },
];
...
const processSteps = [
  ...
  { num: 'ii', day: 'Day 1–3', title: 'Specification', body: 'Engineer-reviewed itemized proposal: hardware, integrations, finishes, timeline. Transparent pricing.' },
  { num: 'iii', day: 'Day 4–7', title: 'Sign-off', body: 'Refinements, finish samples, landmark approvals if applicable. Single sign-off, no surprises.' },
  { num: 'iv', day: 'Day 8–14', title: 'Installation', body: 'The same engineer who scoped it installs it. Most apartment buildings complete in a single business day.' },
  { num: 'v', day: 'Ongoing', title: 'Support & Care', body: '24-hour SLA, remote diagnostics, on-site within 2 business days. Same team, every call.' },
];

const promises = [
  { title: '24-hour response SLA', body: 'A real engineer responds within 24 hours of your inquiry. No automated holding emails, no "we\'ll be in touch shortly," no dropped leads.', meta: 'Written into every quote' },
  { title: '1-year installation guarantee', body: 'If anything fails because of how we installed it within the first year, we fix it free. No debate, no surcharge, no service-call fee. This is on top of the manufacturer warranty.', meta: 'No-questions-asked policy' },
  { title: 'Itemized, no-surprise pricing', body: 'Every quote is itemized line by line — hardware, labor, integrations, contingency. What you see on day one is what you pay on day fifty. No hidden fees, no scope creep.', meta: 'Fixed-fee structure' },
...
const compareRows = [
  ...
  { feature: 'Building codes', us: 'Licensed, insured, code-compliant', them: 'Variable' },
  { feature: 'Historic-building expertise', us: '✓', them: '✗' },
  //{ feature: 'GDPR / DPIA documentation', us: 'Included for biometric installs', them: '✗' },
  { feature: 'Installation guarantee', us: '1 year, no fine print', them: 'Hardware only' },
      ...
      {/* <section className="section wu-process">
        <div className="wrap">
          <div className="section-header wu-section-header">
            ...
            <h2 className="h2">From inquiry to <em className="em">handover.</em></h2>
